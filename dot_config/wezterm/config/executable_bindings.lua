...
local keys = {
  ...
  -- { key = 't',          mods = mod.SUPER_REV, action = act.SpawnTab({ DomainName = 'archlinux' }) },
  ...
  -- panes: navigation
  { key = 'j',     mods = mod.SUPER_REV, action = act.ActivatePaneDirection('Up') },
  ...
  -- panes: scroll pane
  { key = 'p',        mods = mod.SUPER_REV, action = act.ScrollByLine(-5) },
  { key = 'n',        mods = mod.SUPER_REV, action = act.ScrollByLine(5) },
